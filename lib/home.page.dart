...
class _MyHomePageState extends State<MyHomePage> {
          ...
          return ListView.builder(
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                onTap: ()=> _goToCharacterDetails(result.data?['characters']['results'][index]['id'], context),
                title: Text(
  ...
  void _goToCharacterDetails(String? id, BuildContext context) {
    // Navigator.of(context).push(
    //   MaterialPageRoute(builder: (ctx)=> DetailsPage(id: id))
    // );
    Routemaster.of(context).push('/details/$id');
